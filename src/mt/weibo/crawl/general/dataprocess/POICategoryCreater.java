...
public class POICategoryCreater {
	...
	public static void main(String[] args) {
		...
		String categoryCSVFolder = "/Users/vincentgong/Documents/TUD/Master TUD/A Master Thesis/share/configuration/poi_category/";
		POICategoryCreater pcc = new POICategoryCreater(categoryTablename, categoryCSVFolder);
	...
	private void storePOICateToDB(String line) {
		if(null!=line && !"".equals(line)){
			...
			String insertTableSQL = "INSERT INTO "
					...
					+ "(category_id, parent_id, name, name_cn)"
					+ " VALUES"
					+ "(?,?,?,?)";
