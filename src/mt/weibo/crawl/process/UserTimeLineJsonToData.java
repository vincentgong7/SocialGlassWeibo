 ...
 *
 */
public class UserTimeLineJsonToData {
	...
	public static void main(String[] args) {
		...
		UserTimeLineJsonToData utj = new UserTimeLineJsonToData();
		utj.sourceFolder = Utils.getResourceFilePath() + Utils.RESOURCE_FOLDER
				+ Utils.UESER_TIMELINE_FOLDER + "timelinefile/processed/";
		utj.transform();
			...
			for (File f : files) {
				try {
					...
					while (mlr.hasNextLine()) {
						...
						StatusWapper sw = constructStatus(line);
						if(sw!=null){
							List statusList = sw.getStatuses();
	...
	public StatusWapper constructStatus(String json) {
		// TODO Auto-generated method stub
